...
public class DashboardDentistController {
    ...
    public Dentist getByID(@PathVariable("dentistid") Integer dentistlid) throws Exception {
        Dentist dentist = dentistService.getDentistInfobyDentistID(dentistlid);
        return dentist;
    }
    ...
    public Object editProfile(@RequestBody Dentist dentist,@RequestParam Integer dentistId ) throws Exception {
        dentistService.edit(dentist,dentistId);
